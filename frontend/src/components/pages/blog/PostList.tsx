...
export default function PostList({
  ...
  if (loading) {
    return (
      <div className="bg-gray-50/50 py-12 sm:py-16 dark:bg-dark-main">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-dark-txt">{title}</h2>
            <p className="mt-1 text-gray-600 dark:text-dark-txt-secondary">{description}</p>
          </div>
  ...
  return (
    <div className="bg-gray-50/50 py-12 sm:py-16 dark:bg-dark-main">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2">
          {posts.length === 0 ? (
            <div className="col-span-full rounded-2xl border border-gray-200 bg-white py-16 text-center dark:border-dark-third dark:bg-dark-bg">
              <p className="text-gray-500 dark:text-dark-txt-secondary">
                Aún no hay publicaciones. ¡Sé el primero en publicar!
              </p>
              <p className="mt-2 text-sm text-gray-400 dark:text-dark-txt-secondary">
